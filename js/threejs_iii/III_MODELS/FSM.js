...
export class CController{
    ...
    _LoadModels() {
        ...
        loader.load(this._params.model, (fbx) => {
          ...
          loader.setPath('./models/');
          loader.load('walk.fbx', (FBX) => { _OnLoadAnimation('walk', FBX); });
          loader.load('run.fbx', (FBX) => { _OnLoadAnimation('run', FBX); });
          loader.load('idle.fbx', (FBX) => { _OnLoadAnimation('idle', FBX); });
          loader.load('dance.fbx', (FBX) => { _OnLoadAnimation('dance', FBX); });
        });
    }
